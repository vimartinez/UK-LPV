<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="gestionLibros.aspx.cs" Inherits="LPV_Biblio.app.admin.gestionLibros" %>
    ...
    <div id="page">
        <div class="box">
            ...
            <p id="frmAltaLibros">
                ...
                <asp:Button ID="btnNuevoAutor" runat="server" Text="Nuevo Autor" Height="25" Width="80" OnClick="btnNuevoAutor_Click"  /><br />
